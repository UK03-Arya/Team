...
const Card4 = () => {
  return (
    <div className="mt-4 mb-8  md:mx-8  flex xl:mx-48 justify-start ml-10 md:ml-10">
      <div className="relative box-content   md:mx-12 xl:pt-4  drop-shadow-xl rounded-2xl bg-white   ">
        <div>
          <div className=" space-y-2 py-4 ml-4 xl:ml-10  ">
            ...
            <div className="flex">
              ...
              <div className="felx justify-center w-[220px] h-[120px] md:w-[450px] md:h-[120px] lg:w-[700px] ">
              <div className="flex flex-col ml-4 xl:mb-4 xl:ml-20 lg:ml-10 lg:mt-4   ">
          ...
          <div className="flex flex-col md:flex-row ml-8 xl:ml-8 xl:space-x-16  lg:space-x-16 md:space-x-10 ">
            <div className="flex mt-4 flex-col ">
              ...
              <div className="flex ">
                <input
                  type="pp"
                  value="111"
                  className="w-48 text-xs pl-2 h-6 mt-2  xl:w-[350px] xl:px-40 xl:pl-8 xl:h-8 lg:w-[350px] lg:px-40 lg:pl-8 lg:h-8 md:w-64 md:px-40 md:pl-8 md:h-8 rounded-full border-2	 border-gray-400 "
                />
                <span className="absolute text-md left-56 mt-4 	xl:left-80 xl:ml-16 lg:ml-28 ">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex ">
                <input
                  type="text"
                  value="Female"
                  className="w-48 text-xs pl-2   h-6 mt-2  lg:w-[350px] lg:px-40 lg:pl-8 lg:h-8 xl:w-[350px] xl:px-40 xl:pl-8 xl:h-8 md:w-64 md:px-40 md:pl-8 md:h-8 rounded-full border-gray-400 border-2	"
                />
                <span className="absolute text-md right-20 mt-4 lg:right-20  xl:right-32 md:right-10 md:mb-3	">
                  <img
                    src={DownArrow}
                    alt="img"
          ...
          <div className="flex flex-col md:flex-row ml-8 mt-2 xl:ml-8   xl:space-x-16 lg:space-x-16 md:space-x-10 ">
            <div className="flex flex-col">
              <label
                for="DOB"
              ...
              <div className="flex ">
                <input
                  type="pp"
                  value="English"
                  className="w-48 mt-1 text-xs pl-2 h-6 lg:mt-2 lg:w-[350px]  lg:px-40 lg:pl-8 lg:h-8  xl:h-8 xl:w-[350px] xl:px-40 xl:pl-8 md:w-64 md:px-40 md:pl-8 md:h-8 md:mt-2 xl:mt-0  rounded-full border-2	 border-gray-400"
                />
              </div>
            </div>
            <div className="flex flex-col">
              ...
              <div className="flex ">
                <input
                  type="text"
                  value="MCA"
                  className="w-48 text-xs pl-2 h-6 mt-2 xl:mt-4 lg:w-[350px]  lg:px-40 lg:pl-8 lg:h-8 xl:w-[350px] xl:px-40 xl:pl-8 xl:h-8 md:w-64 md:px-40 md:pl-8 md:h-8 rounded-full border-gray-400 border-2	"
                />
              </div>
            </div>
          </div>
          <div className="flex space-x-2   xl:pl-40 md:space-x-4 md:pl-8  lg:pl-36 ml-10 mt-4  xl:ml-40 xl:mb-20 lg:mb-20 lg:ml-40 lg:8 mt- md:ml-48 xl:pb-8 lg:pb-8 md:pb-4 ">

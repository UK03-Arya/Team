...
const Card4 = () => {
  return (
   ...
   {/* <div className="mt-4 mb-8  md:mx-8  flex xl:mx-48 justify-start ml-10 md:ml-10"> */}
    <div className='flex flex-wrap mt-4  h-10   xl:w-[1359px] xl:h-[60px]  md:w-[800px]  lg:w-[1000px] lg:h-[60px] w-[10px]  xl:mx-40  lg:mx-12 md:mx-10   rounded-2xl bg-white justify-between space-x-4    xl:space-x-80 lg:justify-between md:justify-between 	'>

      <div className="relative box-content   md:mx-12 xl:pt-4  drop-shadow-xl rounded-2xl bg-white   ">
        <div>
          <div className=" space-y-2 py-4 ml-8 xl:ml-10  ">
            ...
            <div className="flex ml-4">
              ...
              <div className="flex justify-center w-[300px] h-[120px] md:w-[450px] md:h-[120px] lg:w-[700px] ">
              <div className="flex flex-col  xl:mb-4 xl:ml-20 lg:ml-10 lg:mt-4   ">
                <div className="flex flex-col mr-10 md:mr-1 md:mt-6 lg:mr-0 xl:mr-0 ">
                  <label
                    for="DOB"
          ...
          <div className="flex flex-col md:flex-row ml-8 xl:ml-8 xl:space-x-16  lg:space-x-16 md:space-x-10 ">
            <div className="flex mt-4 flex-col ">
              ...
              <div className="flex ">
                ...
                />
                <span className="absolute text-md left-80 mt-4 	xl:left-80 xl:ml-16 lg:ml-24 md:left-72">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex ">
                ...
                />
                <span className="absolute text-md right-32 mt-4 md:mt-5 lg:right-20  xl:right-32 md:right-10 md:mb-3	">
                  <img
                    src={DownArrow}
                    alt="img"
          ...
          <div className="flex space-x-2   xl:pl-40 md:space-x-4 md:pl-8  lg:pl-36 ml-20 mt-4  xl:ml-40 xl:mb-20 lg:mb-20 lg:ml-40 lg:8 mt- md:ml-48 xl:pb-8 lg:pb-8 md:pb-4 ">
